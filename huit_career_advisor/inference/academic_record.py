...
class HocBaAnalyzer:
    ...
    def load_models(self):
        ...
        path = model_path('hocba_models.pkl')
        if not path.exists():
            print("Chua co models/hocba_models.pkl. Hay chay research/training/train_hocba_models.py truoc.")
            return False
        try:
            ...
            print(f"Loaded HB models ({acc_txt})")
            self._models_loaded = True
            return True
        except Exception as e:
            print(f"Error loading HB models: {e}")
            return False
    ...
    def predict_nganh(self, diem_hb_info, top_k=10, nguyen_vong=''):
        ...
        try:
            ...
            print(f"Academic-record prediction error: {e}")
            return []
